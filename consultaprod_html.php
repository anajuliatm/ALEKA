...
<body>
    <?php
        ...
        $sql = "SELECT * FROM produtos WHERE excluido_produtos='n' ORDER BY id_produtos";
    ...
    $sql2 = "SELECT * FROM produtos WHERE excluido_produtos='n'  ORDER BY id_produtos LIMIT $registros OFFSET $inicio";
...
-->
                ...
                <div id="tabela">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-" id="email"><b>TEMA</b></div>
                            <div class="col-" id="tel"><b>QTDE</b></div>
                            <div class="col-" id="opt"><b>R$</b></div>
                        </div>
                        ...
                        <?php
                            ...
                            ?>
                        <div class="row">
                            <div class="col-" id="id"><?php echo $linha['id_produtos']; ?></div>
                            <div class="col-" id="nome"><?php echo $linha['nome_produtos']; ?></div>
                            <div class="col-" id="email"><?php echo $linha['tema_produtos']; ?></div>
                            <div class="col-" id="tel"><?php echo $linha['qtd_produtos']; ?></div>
                            <div class="col-" id="opt"><?php echo $linha['preco_produtos']; ?></div>
            ...
            for($i = 1; $i < $qtd_pag + 1; $i++){ 
                                echo "<a href='consultaprod_html.php?pagina=$i'><button class='pagina'>".$i."</button></a> &nbsp;" ; 
                            }
